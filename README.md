...
Разработка программного обеспечения для микроконтроллеров STM32 и ESP8266.
Опыт разработки драйверов устройств, работы с RTOS, систем управления, протоколов передачи данных.
Разработка высокоуровнего ПО на Qt для управления и обработки данных устройств на STM32.
Уверенное знание C/C++, опыт работы с Git.

---

## 🛠️ Технологии и стек

- **Языки:** C/C++, Delphi, PostgreSQL, Python, Assembler
- **Микроконтроллеры:** STM32 (F1, F4), ATmega328, ESP8266
- **Периферия:** ADC/DAC, GPIO, таймеры, DMA, wathcdog, RTS, прерывания, DMA, USB, UART/USART, SPI, I2C, CAN
...
- **Промышленные протоколы:** Modbus, CAN, RS-232/485
- **Операционные системы:** Linux, Windows, FreeRTOS
- **Библиотеки:** HAL, LL, CMSIS
- **Автоматические сборки проекта: ** CMake
---

## 📂 Опыт работы

### Инженер-программист встраиваемых систем
**ООО АПС Энергия Рус | Екатеринбург | 21.07.2025 — настоящее время**  
Занимаюсь разработкой ПО для выпрямителя.
- C/C++, STM32F429, FreeRTOS, Bare Metal
- Реализовал систему импульсно-фазового управления тиристорами
- Разработал систему логгирования на SD-карту + передача данных на ПК по USB без остановки записи. Использовал FreeRTOS для решения гонок прерываний
- Написал драйвер на датчик температуры DS18B20, протокол передачи данных между МК и ПК
- Разработал кроссплатформенное ПО на Qt (C++17/20) для мониторинга и управления выпрямителя
- Создал ПО для HMI-панели на базе Linux
...
- Написал хранимые процедуры на PostgreSQL
...
- Разработал с нуля программно-аппаратный комплекс распознавания лиц для контроля доступа с обратной связью.
