...
Разработчик встраиваемых систем с практическим опытом работы STM32F1/F3, ESP32/8266. Опыт работы периферией МК (таймеры, ADC, DMA, прерывания), интерфейсами связи и низкоуровневой логикой.
